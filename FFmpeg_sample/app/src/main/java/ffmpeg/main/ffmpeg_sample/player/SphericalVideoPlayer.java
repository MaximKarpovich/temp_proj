...
import static ffmpeg.main.ffmpeg_sample.MainActivity.toast;

import ffmpeg.main.ffmpeg_sample.gles.EGLRenderTarget;
import ffmpeg.main.ffmpeg_sample.gles.GLHelpers;
import ffmpeg.main.ffmpeg_sample.gles.SphericalSceneRenderer;
...
public class SphericalVideoPlayer extends TextureView {
    ...
    public native void initVideoPlayer(String path);
    ...
    public void play() {
        if (!videoPlayerInternal.isPlaying()) {
            ...
            initVideoPlayer("hello");
        }
    }

    static public void test_method()
    {
        Log.d("DEBUG", "IN PAUSE");
    }
